          ...
          ${
            ...
            <div style="margin-bottom: 8px;">
              ${issue.labels.nodes
                .map(
                  (label) => `
                <span style="display: inline-block; background-color: #${label.color}; color: ${parseInt(label.color, 16) > 0x888888 ? '#000' : '#fff'}; padding: 2px 8px; border-radius: 12px; font-size: 11px; margin-right: 4px;">
                  ${label.name}
                </span>
              `,
                )
